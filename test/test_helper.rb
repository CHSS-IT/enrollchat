...
class ActiveSupport::TestCase
  setup do
    Setting.create!(current_term: 201810, singleton_guard: 0, undergraduate_enrollment_threshold: 12, graduate_enrollment_threshold: 10, email_delivery: 'scheduled') unless Setting.exists?
  end

  teardown do
    Setting.first.destroy if Setting.exists?
  end

class Section < ApplicationRecord
  ...
  def self.import(filepath)
    ...
    Turbo::StreamsChannel.broadcast_replace_later_to("new_data_notification", target: "new-data-available", partial: "sections/new_data_message", locals: { new_sections: @new_sections, updated_sections: @updated_sections })
